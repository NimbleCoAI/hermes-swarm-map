...
echo "  SIGNAL_ALLOWED_USERS=        # empty = no DMs allowed (add phone numbers to allow, or * for all)"
echo "  SIGNAL_GROUP_ALLOWED_USERS=  # empty = no groups allowed (add group IDs to allow, or * for all)"
echo ""
