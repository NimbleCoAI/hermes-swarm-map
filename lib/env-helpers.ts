...
export const POLICY_VARS: Record<string, string[]> = {
  signal: ['SIGNAL_ALLOWED_USERS', 'SIGNAL_GROUP_ALLOWED_USERS', 'SIGNAL_ADMIN_USERS', 'SIGNAL_REQUIRE_MENTION'],
  telegram: ['TELEGRAM_ALLOWED_USERS', 'TELEGRAM_GROUP_ALLOWED_CHATS', 'TELEGRAM_ADMIN_USERS', 'TELEGRAM_REQUIRE_MENTION'],
  mattermost: ['MATTERMOST_ALLOWED_USERS', 'MATTERMOST_ALLOWED_CHANNELS', 'MATTERMOST_ADMIN_USERS', 'MATTERMOST_REQUIRE_MENTION'],
}
