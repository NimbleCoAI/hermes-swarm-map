...
export async function POST(request: Request) {
  try {
    ...
    // Include google-mcp volume only if the directory exists on this host
    const googleMcpCandidateDir = expandPath(process.env.GOOGLE_MCP_DIR || '~/Documents/GitHub/google-mcp')
    const googleMcpDir = fs.existsSync(googleMcpCandidateDir) ? googleMcpCandidateDir : undefined
