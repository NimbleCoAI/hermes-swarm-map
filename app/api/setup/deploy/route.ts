...
function generateCompose(slug: string, port: number, agentDataDir: string, image: string): string {
...
export async function POST(request: Request) {
  try {
    ...
    fs.writeFileSync(composePath, generateCompose(slug, port, agentDataDir, hermesImage), 'utf-8')
